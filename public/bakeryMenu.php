...
<?php include('./components/nav.php') ?>
    <div id="Menuintro">
        <div class="rounded border-light jumbotron py-5 px-4">
            <h1 style="font-family: 'Abril Fatface', serif;">Bakery Items</h1>
            <p>Enjoy a delicious treat with your coffee</p>
        </div>
    </div>
    <section></section>
    <div class="dark-section">
        <div class="container overflow-auto site-section" id="why">
            <div id="product-grid">
                ...
                <?php
                $product_array = $db_handle->runQuery("SELECT * FROM product WHERE category='bakery' ORDER BY id ASC");
